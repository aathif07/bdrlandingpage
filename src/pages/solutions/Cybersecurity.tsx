...
const Cybersecurity = () => {
  ...
  // Changed: Initialize isCallbackActive to true for continuous jiggle
  ...
  useEffect(() => {
    document.title = "Cybersecurity | Big Data Rhino";
  ...
  const handleOpenPopup = () => {
    setShowPopup(true);
    // This line is technically redundant now, as isCallbackActive is already true.
    // However, it doesn't cause any issues.
    setIsCallbackActive(true); 
  };

  const handleClosePopup = () => {
    setShowPopup(false);
    // Changed: Removed setIsCallbackActive(false) to ensure the icon keeps jiggling
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      const callbackData = {
        ...formData,
        source: 'Cybersecurity Solutions Page'
      };
      ...
      // Option 1: Keep it as is if you want the jiggling to stop after a successful submission.
      setIsCallbackActive(false); 
      // Option 2: Comment out or remove the above line if you want the jiggling to continue
      // even after a successful callback has been scheduled.
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
          ...
          <div className="prose dark:prose-invert max-w-none">
            <p className="text-lg mb-6">
              Our comprehensive cybersecurity solutions protect your data, systems, and networks from modern threats through advanced technology and proactive practices.
            </p>
            ...
            <div className="mt-8 p-6 bg-gray-100 dark:bg-gray-800 rounded-md shadow-md">
              <h2 className="text-xl font-semibold mb-4">Secure Your Future: Request a Cybersecurity Consultation</h2>
              <p className="mb-4">
                Connect with our cybersecurity experts to fortify your digital defenses.
              </p>
              <CallbackButton
                isCallbackActive={isCallbackActive} // This prop now correctly ensures continuous jiggle
                phoneIcon={phoneIcon}
