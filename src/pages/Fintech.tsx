...
import { FiArrowRight, FiCheck, FiDollarSign, FiShield, FiCreditCard, FiPieChart, FiTrendingUp } from 'react-icons/fi';
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
            <div className="space-y-8">
              <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold leading-tight">
                <span className="text-indigo-600">Fintech</span> Solutions
              </h1>
              <p className={`text-xl ${theme === 'dark' ? 'text-gray-300' : 'text-gray-600'}`}>
                Transform your financial services with our cutting-edge fintech solutions that leverage big data, AI, and blockchain technologies to drive innovation and growth.
              </p>
        ...
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-16">
            ...
            <p className={`text-xl ${theme === 'dark' ? 'text-gray-300' : 'text-gray-600'} max-w-3xl mx-auto`}>
              We provide comprehensive fintech solutions that help financial institutions innovate and stay competitive.
            </p>
          </div>
