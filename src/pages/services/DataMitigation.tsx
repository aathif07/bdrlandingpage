...
const DataMigration = () => {
  ...
  useEffect(() => {
    document.title = "Data Migration | Big Data Rhino";
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      const callbackData = {
        ...formData,
        source: 'Data Migration Services Page'
      };
    ...
    <div className={`min-h-screen ${theme === 'dark' ? 'dark' : ''}`}>
      ...
      <main className="pt-24">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
          <h1 className="text-4xl font-bold mb-8">Data Migration Services</h1>
          <div className="prose dark:prose-invert max-w-none">
            ...
            <ul className="list-disc pl-6 space-y-2 mb-6">
              <li>Comprehensive data risk assessment</li>
              <li>Development of customized migration strategies</li>
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-8">
              <div className="bg-white dark:bg-gray-800 p-6 rounded-lg shadow-md">
                <h3 className="text-xl font-medium mb-3">Reduced Vulnerability</h3>
                <p>Identify and address potential data breach points before they become liabilities.</p>
              </div>
              <div className="bg-white dark:bg-gray-800 p-6 rounded-lg shadow-md">
                <h3 className="text-xl font-medium mb-3">Regulatory Compliance</h3>
                <p>Stay compliant with GDPR, CCPA, HIPAA, and other relevant data protection regulations.</p>
              </div>
              <div className="bg-white dark:bg-gray-800 p-6 rounded-lg shadow-md">
                <h3 className="text-xl font-medium mb-3">Enhanced Trust</h3>
                <p>Build customer confidence through demonstrated commitment to data protection.</p>
              </div>
            </div>

            <div className="mt-8 p-6 bg-gray-100 dark:bg-gray-800 rounded-md shadow-md">
              <h2 className="text-xl font-semibold mb-4">Ready to Discuss Your Data Migration Needs?</h2>
              <p className="mb-4">
