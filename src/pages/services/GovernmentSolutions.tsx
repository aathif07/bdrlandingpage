...
const GovernmentSolutions = () => {
  ...
  useEffect(() => {
    document.title = "Government Solutions | Big Data Rhino";
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      const callbackData = {
        ...formData,
        source: 'Government Solutions Page'
      };
    ...
    <div className={`min-h-screen ${theme === 'dark' ? 'dark' : ''}`}>
      ...
      <main className="pt-24">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
          <h1 className="text-4xl font-bold mb-8">Government Solutions</h1>
          <div className="prose dark:prose-invert max-w-none">
            <p className="text-lg mb-6">
              Our specialized solutions for government agencies and public sector organizations help modernize operations, enhance security, and improve service delivery.
            </p>
            <div className="bg-white dark:bg-gray-800 p-6 rounded-lg shadow-md mb-6">
              <h2 className="text-2xl font-semibold mb-4">Key Offerings</h2>
              <ul className="list-disc pl-6 space-y-2">
                <li>Secure data infrastructure and compliance solutions</li>
                <li>Digital transformation of government services</li>
                <li>Citizen engagement platforms and applications</li>
                <li>Advanced analytics for policy and decision support</li>
            ...
            <div className="mt-8 p-6 bg-gray-100 dark:bg-gray-800 rounded-md shadow-md">
              <h2 className="text-xl font-semibold mb-4">Discuss Your Government Sector Needs</h2>
              <p className="mb-4">
                Learn how our tailored technology solutions can empower your agency. Connect with our government solutions experts for a consultation.
              </p>
              <CallbackButton 
